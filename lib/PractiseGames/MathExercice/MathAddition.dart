...
class MathAdditionGame extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MathAdditionExercise();
  }
}

class MathAdditionExercise extends StatefulWidget {
  @override
  _MathAdditionExerciseState createState() => _MathAdditionExerciseState();
}
...
class _MathAdditionExerciseState extends State<MathAdditionExercise> {
  ...
  final int maxNumber = 10; // max number for addition to keep it simple
  ...
  void generateNewQuestion() {
    ...
    setState(() {
      ...
      secondNumber = rand.nextInt(maxNumber) + 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text('Jeu d\'Addition', style: TextStyle(fontWeight: FontWeight.bold)),
        ),
      ),
      body: Stack(
        children: [
