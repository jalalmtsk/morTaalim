...
class MathSubtractionGame extends StatelessWidget {
  @override
  Widget build(BuildContext context) => MathSubtractionExercise();
}

class MathSubtractionExercise extends StatefulWidget {
  @override
  _MathSubtractionExerciseState createState() => _MathSubtractionExerciseState();
}
...
class _MathSubtractionExerciseState extends State<MathSubtractionExercise>
  ...
  void _generateNewQuestion() {
    setState(() {
      firstNumber = _rng.nextInt(_maxAnswer) + 1;
      secondNumber = _rng.nextInt(firstNumber) + 1; // ensure no negative answers
            ...
            SafeArea(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  final contentWidth = constraints.maxWidth.clamp(0, 720);
                  final isWide = contentWidth >= 520;
                  final buttonSize = isWide ? 64.0 : 56.0;
                  final buttonCrossAxisCount = isWide ? 5 : 4;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: isWide ? 40 : 36,
                                    fontWeight: FontWeight.bold,
                                    color: themeColor),
                              ),
                              const SizedBox(height: 20),
                              GridView.count(
                                crossAxisCount: buttonCrossAxisCount,
                                mainAxisSpacing: 10,
                                crossAxisSpacing: 10,
                                shrinkWrap: true,
