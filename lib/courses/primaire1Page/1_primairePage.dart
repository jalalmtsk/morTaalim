...
class _primaire1State extends State<primaire1> {
  final List<Map<String, String>> courses = [
    ...
    {'title': 'Francais', 'file': 'assets/courses/primary/economics.json'},
    {'title': 'Education Islamique', 'file': 'assets/courses/primary/primaire1/Education_Islamique/1primaire_education_islamique.json'},
    {'title': 'Education Artistique', 'file': 'assets/courses/primary/macroeconomics.json'},
  ];
