...
class primaire6 extends StatefulWidget {
  @override
  _primaire6State createState() => _primaire6State();
}

class _primaire6State extends State<primaire6> {
