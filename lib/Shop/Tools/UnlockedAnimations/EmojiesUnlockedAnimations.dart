...
class EmojiUnlockedDialog extends StatefulWidget {
  final String emoji;
  final int xpReward;

  const EmojiUnlockedDialog({required this.emoji, this.xpReward = 20, super.key});

  @override
  State<EmojiUnlockedDialog> createState() => _EmojiUnlockedDialogState();
}

class _EmojiUnlockedDialogState extends State<EmojiUnlockedDialog> with TickerProviderStateMixin {
              ...
              child: ScaleTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Emoji display
                    // Inside the Column, replace the current emoji + Lottie section with this:
                    Stack(
                      alignment: Alignment.center,
                      children: [
