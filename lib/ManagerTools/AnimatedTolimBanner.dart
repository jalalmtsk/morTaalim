...
class AnimatedTokenBanner extends StatefulWidget {
  ...
  const AnimatedTokenBanner({
    required this.tokenAmount,
    required this.onDismiss,
  });

  @override
  State<AnimatedTokenBanner> createState() => _AnimatedTokenBannerState();
}
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            '+${widget.tokenAmount} Tolim${widget.tokenAmount > 1 ? 's' : ''}!',
